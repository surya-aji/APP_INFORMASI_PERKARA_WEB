                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="{{asset('public/auth/app-assets/images/pages/login.png')}}" alt="branding logo">
                                </div>
                                            ...
                                            <div class="card-body pt-1">
                                                <form  method ="POST" action ="{{url('/logged')}}">
                                                    ...
                                                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                        <input type="text" class="form-control" id="nomor_perkara" name="nomor_perkara" placeholder="Nomor Perkara">
                                                    ...
                                                    <fieldset class="form-label-group position-relative has-icon-left">
                                                        <input type="password" class="form-control" id="perkara_id" name="perkara_id" placeholder="ID Perkara">
                                                        <div class="form-control-position">
                                                            <i class="feather icon-lock"></i>
                                                        </div>
                                                        <label for="perkara_id">ID Perkara</label>
                                                    </fieldset>
