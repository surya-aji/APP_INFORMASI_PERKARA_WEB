<!-- BEGIN: Vendor JS-->
    ...
    <script src="{{asset('public/app-assets/vendors/js/calendar/fullcalendar.min.js')}}"></script>
    <script src="{{asset('public/app-assets/vendors/js/calendar/extensions/daygrid.min.js')}}"></script>
    <script src="{{asset('public/app-assets/vendors/js/calendar/extensions/timegrid.min.js')}}"></script>
    <script src="{{asset('public/app-assets/vendors/js/calendar/extensions/interactions.min.js')}}"></script>
